...
//     return request({
//         url: `/ncqsystem/brandShop/brandRecommendList/${merchantId}`,
//         method: 'get',
//     })
// }
...
Api.ghdetail = function (ghOrderId) {
    return request({
        url: `/ncqsystem/gh/detail/${ghOrderId}`,
        method: 'get',
    })
}
...
Api.cgdetail = function (cgOrderId) {
    return request({
        url: `/ncqsystem/cg/detail/${cgOrderId}`,
        method: 'get',
    })
}
...
Api.ghtreeGoodsTypeList = function () {
    return request({
        url: '/ncqsystem/gh/treeGoodsTypeList',
        method: 'get',
    })
}
...
Api.ghgoodsWeightTypeList = function () {
    return request({
        url: '/ncqsystem/gh/goodsWeightTypeList',
        method: 'get',
    })
}
...
Api.cgpurchase = function (cgInfoId, data) {
    return request({
        url: `/ncqsystem/cg/purchase/${cgInfoId}`,
        method: 'put',
        params: data,
    })
}
...
Api.ghprovide = function (cgInfoId, data) {
    return request({
        url: `/ncqsystem/gh/provide/${cgInfoId}`,
        method: 'put',
        params: data,
    })
}
...
Api.shopCartList = function () {
    return request({
        url: '/ncqsystem/shopCart/shopCartList',
        method: 'get',
    })
        .then(res => {
...
Api.shopCartdelete = function (shopCartId) {
    return request({
        url: `/ncqsystem/shopCart/delete/${shopCartId}`,
        method: 'delete',
    })
}
...
Api.shopCartCommit = function (data) {
    return request({
        url: '/ncqsystem/shopCart/commitShopCart',
        method: 'put',
        params: data,
    })
}
...
Api.ghGoodsTypeList = function () {
    return request({
        url: '/ncqsystem/gh/ghGoodsTypeList',
        method: 'get',
    })
}
...
Api.cgGoodsTypeList = function () {
    return request({
        url: '/ncqsystem/cg/cgGoodsTypeList',
        method: 'get',
    })
}
