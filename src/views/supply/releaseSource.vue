		...
		<div class="source-flow-form">
			<div class="source-form-panel">
				...
				<el-form ref="Form" :model="sourceForm" :rules="Rules" label-position="right" label-width="120px">
					<el-form-item prop="name" label="名称"><el-input style="width: 500px" placeholder="请输入商品名称" v-model="sourceForm.name" /></el-form-item>
					...
					<el-form-item prop="chooseDate" label="发货时间">
						<el-date-picker
							style="width: 500px"
					...
					<el-form-item prop="mainParams" label="主要参数">
					...
					<el-form-item prop="goodsPic" label="商品图片">
						<uploadImg moduleName="ncq" ref="uploadImage" :limit="5" v-model="sourceForm.goodsPic"></uploadImg>
					</el-form-item>
					<el-form-item prop="company" label="物流公司"><el-input style="width: 500px" placeholder="请输入您选择的物流公司" v-model="sourceForm.company" /></el-form-item>
					<el-form-item label="物流费用" required>
						<el-row>
							<el-col :span="4">
								<el-form-item prop="moneyValue" style="padding-top: 0;">
									<el-input v-model="sourceForm.moneyValue" placeholder="请输入金额" style="width: 120px" />
									<span style="margin-left: 10px;">元</span>
								</el-form-item>
							</el-col>
							<el-col :span="11">
	...
	methods: {
		...
		async ghrelease() {
			...
			let res = await ApiAuth.ghrelease({
				...
				goodsImageList: this.sourceForm.goodsPic,
